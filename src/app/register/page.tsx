      ...
      <Card className="w-full max-w-md shadow-lg border-0 ring-1 ring-slate-200">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Input id="name" type="text" placeholder="John Doe" required className="focus-visible:ring-emerald-500" />
          </div>
          <div className="space-y-2">
          ...
          <Button className="w-full bg-emerald-500 hover:bg-emerald-600 text-white mt-4 h-11 text-base">
            Create Account
          </Button>
        </CardContent>
