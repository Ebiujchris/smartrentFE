            ...
            <section>
              ...
              <div className="bg-slate-50 p-4 rounded-lg my-3">
                ...
                <ul className="space-y-2">
                  <li><strong>Starter:</strong> 1–7 Units - UGX 75,000/month</li>
                  <li><strong>Professional:</strong> 8–30 Units - UGX 150,000/month</li>
                  <li><strong>Premium:</strong> 31+ Units (Unlimited) - UGX 300,000/month</li>
                </ul>
              </div>
